...
class TripPlan(BaseModel):
    ...
    knowledge_references: Optional[List[Dict[str, Any]]] = Field(default=None, description="知识库参考")
...
class KnowledgeQueryRequest(BaseModel):
    """知识库查询请求"""
    query: str = Field(..., description="查询文本", example="北京故宫旅游攻略")
    city: Optional[str] = Field(default=None, description="按城市过滤", example="北京")
...
class KnowledgeQueryResponse(BaseModel):
    ...
    success: bool = Field(..., description="是否成功")
    message: str = Field(default="", description="消息")
    data: List[KnowledgeDocument] = Field(default=[], description="知识文档列表")


class KnowledgeAddRequest(BaseModel):
    """添加知识文档请求"""
    content: str = Field(..., description="文档内容（Markdown格式）")
    metadata: Dict[str, Any] = Field(default={}, description="文档元数据（城市、标题等）")
...
class KnowledgeStatsResponse(BaseModel):
    ...
    success: bool = Field(..., description="是否成功")
    message: str = Field(default="", description="消息")
    data: Optional[Dict[str, Any]] = Field(default=None, description="统计信息")
